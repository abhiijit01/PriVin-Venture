    ...
    public class CounterController : Controller
    {
        ...
        public JsonResult InsertCounter(Counter theCounter)
        {
            try
            {
                ...
                {
                    returnvf = BLL.CounterManagement.GetInstance.UpdateCounter(theCounter);
                }
                else
                {
                    returnvf = BLL.CounterManagement.GetInstance.InsertCounter(theCounter);
                }
        ...
        public JsonResult UpdateCounter(Counter theCounter)
        {
            try
            {
                int returnvf = BLL.CounterManagement.GetInstance.UpdateCounter(theCounter);
        ...
        public JsonResult ViewCounterDDL()
        {
            ...
            return Json(Counterlist, JsonRequestBehavior.AllowGet);
