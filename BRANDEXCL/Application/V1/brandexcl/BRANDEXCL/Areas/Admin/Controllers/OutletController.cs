    ...
    public class OutletController : Controller
    {
        ...
        public JsonResult InsertOutlet(Outlets theRole)
        {
            try
            {
                if (theRole.outid >= 1)
                {
                    returnvf = BLL.OutletsManagement.GetInstance.UpdateOutlet(theRole);
                }
                else
                {
                    returnvf = BLL.OutletsManagement.GetInstance.InsertOutlet(theRole);
                }
        ...
        public JsonResult UpdateOutlet(Outlets theRole)
        {
            try
            {
                int returnvf = BLL.OutletsManagement.GetInstance.UpdateOutlet(theRole);
