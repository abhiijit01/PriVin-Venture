    ...
    public class BrandController : Controller
    {
        ...
        public JsonResult InsertBrand(Brand theRole)
        {
            try
            {
                ...
                {
                    returnvf = BLL.BrandManagement.GetInstance.UpdateBrand(theRole);
                }
                else
                {
                    returnvf = BLL.BrandManagement.GetInstance.InsertBrand(theRole);
                }
        ...
        public JsonResult UpdateBrand(Brand theRole)
        {
            try
            {
                int returnvf = BLL.BrandManagement.GetInstance.UpdateBrand(theRole);
