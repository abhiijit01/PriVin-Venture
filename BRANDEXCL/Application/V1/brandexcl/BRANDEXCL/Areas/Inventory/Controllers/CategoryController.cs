    ...
    public class CategoryController : Controller
    {
        ...
        public JsonResult InsertCategory(Category theRole)
        {
            try
            {
                if (theRole.catid >= 1)
                {
                    returnvf = BLL.CategoryManagement.GetInstance.UpdateCategory(theRole);
                }
                else
                {
                    returnvf = BLL.CategoryManagement.GetInstance.InsertCategory(theRole);
                }
        ...
        public JsonResult UpdateCategory(Category theRole)
        {
            try
            {
                int returnvf = BLL.CategoryManagement.GetInstance.UpdateCategory(theRole);
