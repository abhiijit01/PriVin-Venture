    ...
    public class SizeController : Controller
    {
        ...
        public JsonResult InsertSize(Size theSize)
        {
            try
            {
                if (theSize.sizeid >= 1)
                {
                    returnvf = BLL.SizeManagement.GetInstance.UpdateSize(theSize);
                }
                else
                {
                    returnvf = BLL.SizeManagement.GetInstance.InsertSize(theSize);
                }
        ...
        public JsonResult UpdateSize(Size theSize)
        {
            try
            {
                int returnvf = BLL.SizeManagement.GetInstance.UpdateSize(theSize);
