...
namespace BRANDEXCL.Controllers
{
    [RoutePrefix(API_ROUTE)]
    public class MailerController : ApiController
    {
        private const string API_ROUTE = "api/Mailer";
        // GET: Inventory/Mailer
        [Route("SendDailySalesReport"), HttpGet]
        public IHttpActionResult SendDailySalesReport()
        {
            ...
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    //string file = "\\ExcelFiles\\DailySaleReport.xlsx";

                    string file = HttpContext.Current.Server.MapPath("/")  + "\\ExcelFiles\\DailySaleReport.xlsx"; //this will give you the full path of project folder.
        ...
        [Route("SendDailyProfitLossReport"), HttpGet]
        public IHttpActionResult SendDailyProfitLossReport()
        {
            ...
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    string file = HttpContext.Current.Server.MapPath("/") + "\\ExcelFiles\\DailyProfitLossReport.xlsx"; //this will give you the full path of project folder.
                    if (System.IO.File.Exists(file))
                    {
                        System.IO.File.Delete(file);
                    }
        ...
        [Route("SendWeeklyStockReport"), HttpGet]
        public IHttpActionResult SendWeeklyStockReport()
        {
            ...
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    //this path will return current project folder
                    string file = HttpContext.Current.Server.MapPath("/") + "\\ExcelFiles\\WeeklyStockReport.xlsx"; //this will give you the full path of project folder.
                    if (System.IO.File.Exists(file))
                    {
                        System.IO.File.Delete(file);
                    }
