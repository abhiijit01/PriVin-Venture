...
namespace BRANDEXCL.Areas.Outlet.Controllers
{
    public class CustmerController : Controller
    {
        ...
        public JsonResult SelectCustmerByMobileNo(string mobileno)
        {
            ...
            dt = BRANDEXCL.Business.CustmerManagement.GetInstance.SelectCustmerByMobileNo(mobileno);
          ...
          try
            {
                ...
                {
                    returnvf = BRANDEXCL.Business.CustmerManagement.GetInstance.SaveCustmerDetail(theCustmer);
                }
                if (returnvf >=1)
                {
