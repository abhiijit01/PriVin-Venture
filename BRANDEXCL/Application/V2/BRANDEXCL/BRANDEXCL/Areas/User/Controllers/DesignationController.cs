    ...
    public class DesignationController : Controller
    {
        ...
        public JsonResult CreateDesignation(UserDesignation theDesgn)
        {
            try
            {
                ...
                {
                    ReturnValue = BRANDEXCL.Business.UserDesignationBS.GetInstance.UpdateUserDesignation(theDesgn);
                }
              else
                {
                    ReturnValue = BRANDEXCL.Business.UserDesignationBS.GetInstance.CreateUserDesignation(theDesgn);
                }
